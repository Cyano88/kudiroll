...
| 0:38-0:58 | Payout methods: private payroll funds, Payroll controls, and completed shield link | "The connected Ready account funds payroll with a separate public USDC shield. KudiRoll can protect a reserve, cap each pay run, or pause payouts, while Ready keeps custody and final approval. These controls do not create a separate treasury account." |
