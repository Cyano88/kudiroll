...
- WebAuthn challenges and KudiRoll sessions remain process-local and must move to a durable expiring store before horizontal scaling; the current Railway service must stay single-replica during E1a certification.
