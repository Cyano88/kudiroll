...
The live app now has Home, Personal payroll and Enterprise navigation, separate workspace records, and durable payment-recovery controls. Follow the [two-minute judge walkthrough](docs/JUDGE_WALKTHROUGH.md). The submission note also records the latest Paycrest discrepancy: the provider reports the funded order as expired while its exact onchain payment before expiry is verified. Bank delivery and refund remain unconfirmed. The current demo video link was updated on 6 September 2026.
